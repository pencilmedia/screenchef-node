...
<!--               <li><a href="@@context/components/tabs/" data-id="tabs">@@titleTab</a></li> -->
              ...
              <li> <!-- Subtree -->
                ...
                <ul class="nav nav-pills nav-stacked tree">
                  ...
                  <li><a href="@@context/components/select_angular/" data-id="long-list-single">@@titleSelectAngular</a></li>
       ...
       <li><h2 class="tree-toggler"><i class="fa fa-caret-down"></i>Patterns</h2>
           <ul class="nav nav-pills nav-stacked tree">
              <li><a href="@@context/patterns/tables/" data-id="tables">@@titleForTable</a></li>
           </ul>
       </li>
   </ul>
</nav>	